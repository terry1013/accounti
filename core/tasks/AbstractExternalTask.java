...
public abstract class AbstractExternalTask implements Runnable {
	...
	public void run() {
		try {
			AccountI.logger.log(Level.INFO, this.getClass().getName() + " started.");
			AccountI.logger.log(Level.INFO, this.getClass().getName() + " found parameters: " + properties.toString());
			
			executeExternalTask();

			AccountI.logger.log(Level.INFO, this.getClass().getName() + " End.");
		} catch (Exception e) {
