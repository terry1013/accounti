...
public class ResetPassword extends TAbstractAction {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (r != null) {
			...
			int o = JOptionPane.showOptionDialog(AccountI.frame, msg, TStringUtils.getBundleString("action.reset.title"),
			...
			if (o == JOptionPane.YES_OPTION) {
				...
				AccountI.showNotification("sle.ui.msg22", r.getFieldValue("username"), r.getFieldValue("password"));
			}
		}
	}
}