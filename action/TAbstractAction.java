...
public abstract class TAbstractAction extends AbstractAction {
	...
	public JDialog getDialog(JComponent pane, String tit) {
		JDialog dialog = new JDialog(AccountI.frame, true);
		...
		if (dimentionFactor > 0) {
			dialog.setSize(AccountI.frame.getSizeBy(dimentionFactor).getSize());
		}
		dialog.setLocationRelativeTo(AccountI.frame);
